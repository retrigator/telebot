...
def handle(msg):
        ...
        if(command.startswith('/chatbot')):
            ...
            options.binary_location = '/app/telebot/heroku-buildpack-google-chrome/bin/compile'
            # get chromedriver from 
            # https://sites.google.com/a/chromium.org/chromedriver/downloads
            browser = webdriver.Chrome(chrome_options=options, executable_path='/app/telebot/heroku-buildpack-chromedriver/bin/compile')
            al=("Launching... it may take upto 20 seconds")
            bot.sendMessage(chat_id,al)
            driver.get('https://www.eviebot.com/en/')
            i=0
